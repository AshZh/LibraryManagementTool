...
class BookStorageViewer(QWidget):
    ...
    def setUpUI(self):
        ...
        searchCondision = ['按书名查询', '按书号查询','按ISSN查询', '按作者查询', '按分类查询', '按出版社查询']
        ...
        self.queryModel.setHeaderData(4, Qt.Horizontal, "分类")
        self.queryModel.setHeaderData(5, Qt.Horizontal, "出版社")
        self.queryModel.setHeaderData(6, Qt.Horizontal, "出版时间")
        self.queryModel.setHeaderData(7, Qt.Horizontal, "是否被借")
        self.queryModel.setHeaderData(8, Qt.Horizontal, "馆藏位置")

        self.queryModel.setHeaderData(9, Qt.Horizontal, "借书人名字")#借书人名字
        self.queryModel.setHeaderData(10, Qt.Horizontal, "借书人科室")#借书人科室
        self.queryModel.setHeaderData(11, Qt.Horizontal, "借阅时间")#借书人科室
